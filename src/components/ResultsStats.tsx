...
const ResultsStats = () => {
 ...
 viewport={{ once: true }}
 className="text-4xl md:text-5xl lg:text-7xl font-semibold text-white uppercase tracking-tighter font-fredoka"
 >
 ...
 <h3 className="text-6xl md:text-8xl font-semibold text-white tracking-tighter tabular-nums ">
 {stat.value}
 </h3>
 <div className="flex flex-col items-start justify-center gap-1">
 <span className="text-white/90 font-medium text-xl md:text-2xl uppercase tracking-widest">
 ...
 >
 {marqueeItems.map((stat, index) => (
 <h3 key={`secondary-${stat.id}-${index}`} className="text-7xl md:text-[10rem] font-semibold text-transparent bg-clip-text tracking-tighter" style={{ WebkitTextStroke: '2px rgba(255,255,255,0.2)' }}>
