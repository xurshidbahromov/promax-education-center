                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <Link href="/" className="inline-block group">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-2xl font-black tracking-tight text-gray-900 dark:text-white leading-tight">
                        ...
                        <ul className="space-y-5">
                            <li className="flex items-start gap-4 group cursor-pointer">
                                ...
                                <div className="pt-0.5">
                                    <p className="text-sm font-bold text-gray-900 dark:text-white mb-0.5">Manzil</p>
                            ...
                            <li className="flex items-center gap-4 group cursor-pointer">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-900 dark:text-white mb-0.5">Telefon</p>
                            ...
                            <li className="flex items-center gap-4 group cursor-pointer">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-900 dark:text-white mb-0.5">Email</p>
