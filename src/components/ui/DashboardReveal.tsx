...
export default function DashboardReveal({ isLoading = false }: { isLoading?: boolean }) {
 ...
 >
 <h2 className="text-2xl font-medium text-gray-800 dark:text-slate-100 tracking-[0.2em] uppercase">
 Promax
 </h2>
 <p className="text-brand-blue text-xs font-medium tracking-[0.4em] mt-2 uppercase animate-pulse">
