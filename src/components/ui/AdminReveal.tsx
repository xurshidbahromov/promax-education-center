...
export default function AdminReveal({ 
  ...
  const roleLabel = role === 'teacher' ? "Ustoz Kabineti" : role === 'staff' ? "Xodim Portali" : "Boshqaruv Tizimi";

  return (
    <AnimatePresence>
      {!isFinished && (
        <motion.div
          key="admin-notebook-pen-reveal"
          initial={{ opacity: 1 }}
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <motion.div
              ...
              className="w-[32rem] h-[32rem] rounded-full bg-gradient-to-tr from-indigo-600/20 via-brand-blue/15 to-emerald-500/20 blur-[110px]"
            />
          </div>
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center drop-shadow-[0_8px_20px_rgba(79,70,229,0.3)]"
            >
              <Image
                src="/Logo_without_sentence.png"
                alt="Promax Admin Portal"
                fill
                priority
            ...
            {/* ── Realistic Spiral Admin Ledger Notebook (Boshqaruv Jurnali) ── */}
            <div className="relative w-full max-w-[340px] bg-white/85 dark:bg-slate-900/85 backdrop-blur-2xl rounded-3xl p-5 sm:p-6 border border-white/90 dark:border-slate-800/90 shadow-[0_20px_50px_rgba(79,70,229,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.6)] overflow-hidden">
              ...
              <div className="absolute left-10 top-0 bottom-0 w-px bg-indigo-400/40 dark:bg-indigo-500/30 z-10" />
              ...
              <div className="relative pl-8 pt-2 pb-1 h-28 flex items-center">
                ...
                >
                  <defs>
                    <linearGradient id="adminPenInk" x1="0%" y1="0%" x2="100%" y2="0%">
                  ...
                  >
                    ...
                    <g transform="rotate(40)">
                      ...
                      <circle cx="0" cy="-7" r="0.9" fill="#4F46E5" />

                      {/* Pen Neck Collar */}
                      <rect x="-4.5" y="-15" width="9" height="3" fill="#0F172A" rx="0.5" />

                      {/* Pen Body (Indigo Gloss Metallic Barrel) */}
                      <polygon points="-4.5,-15 4.5,-15 5.5,-45 -5.5,-45" fill="#4F46E5" />
                      
                      {/* Chrome Ring Trim */}
                      <rect x="-5" y="-30" width="10" height="2.5" fill="#E2E8F0" />
                      
                      {/* Brand Emerald Accent Band */}
                      <rect x="-5.5" y="-42" width="11" height="3.5" fill="#10B981" rx="0.5" />
                    </g>
                  </motion.g>
