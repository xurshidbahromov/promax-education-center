                        ...
                        >
                            <div className="flex flex-col gap-2">
                                {['home', 'courses', 'methodology', 'results', 'about'].map((item) => (
                                    <Link
                                        ...
                                        href={item === 'home' ? '/' : `/${item}`}
                                        className={cn(
                                            "text-lg font-bold px-4 py-3 rounded-2xl transition-colors",
                                            isActive(item)
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col gap-3">
                                    <span className="text-xs font-black text-gray-400 uppercase tracking-widest px-2">Theme</span>
                                        ...
                                        {(['light', 'dark', 'system'] as const).map((mode) => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    theme === mode ? "bg-black/10 dark:bg-white/10 text-gray-900 dark:text-white" : "text-gray-500 hover:bg-black/5 dark:hover:bg-white/5"
                                                )}
                                            >
                                ...
                                <div className="flex flex-col gap-3">
                                    <span className="text-xs font-black text-gray-400 uppercase tracking-widest px-2">Lang</span>
                                    <div className="flex gap-2">
                                        {(['UZ', 'EN', 'RU'] as const).map((lang) => (
                                            <button
                                                key={lang}
                                                ...
                                                className={cn(
                                                    "p-2 rounded-xl transition-all flex-1 text-sm font-bold flex justify-center items-center",
                                                    language === lang
                            ...
                            <div className="flex flex-col gap-3 mt-2">
                                <Link
                                    href="/login"
                                    className="w-full py-4 text-center rounded-full font-bold text-gray-800 dark:text-gray-200 bg-black/5 dark:bg-white/5 hover:bg-black/10 transition-colors"
                                    onClick={() => setMobileMenuOpen(false)}
                                >
                                    {t('auth.login.title')}
                                </Link>
                                <Link
                                    href="/register"
                                    className="w-full py-4 text-center rounded-full font-bold text-white bg-brand-blue hover:bg-blue-700 shadow-xl shadow-brand-blue/20 transition-all active:scale-95"
                                    onClick={() => setMobileMenuOpen(false)}
                                >
