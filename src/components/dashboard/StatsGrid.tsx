...
export default function StatsGrid({ userId }: { userId?: string }) {
 ...
 <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl p-5 sm:p-6 rounded-[1.5rem] border border-white/60 dark:border-slate-700/50 shadow-sm active:border-brand-blue/30 dark:active:border-brand-blue/30 active:scale-95 transition-all duration-300 relative z-10 overflow-hidden h-full flex flex-col justify-between group">
 ...
 <div className="absolute -right-4 -bottom-4 opacity-[0.03] dark:opacity-[0.03] group-active:opacity-[0.08] dark:group-active:opacity-[0.08] group-active:scale-95 transition-all duration-500 text-slate-900 dark:text-white">
