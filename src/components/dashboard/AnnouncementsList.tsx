...
const AnnouncementItem = memo(({ item }: { item: any }) => {
 const { t } = useLanguage();
 return (
 <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-md active:bg-white/60 dark:active:bg-slate-800/60 p-4 rounded-2xl border border-white/50 dark:border-slate-700/50 flex gap-4 transition-all duration-300 active:scale-95 group">
 ...
 <div>
 <h4 className="font-medium text-slate-800 dark:text-slate-100 group-active:text-brand-blue transition-colors">{item.title}</h4>
