...
export default function TelegramLoginWidget({
 ...
 className={`w-full py-3.5 px-4 bg-[#2AABEE] active:bg-[#229ED9] text-white rounded-xl font-medium transition-all shadow-lg shadow-[#2AABEE]/20 /40 flex items-center justify-center gap-3 mt-2 ${!isScriptLoaded ? 'opacity-70 cursor-not-allowed' : ''}`}
 >
