...
export default function MyCourses() {
    ...
    if (courses.length === 0) {
        return (
            <div className="bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl rounded-3xl border border-white/60 dark:border-slate-800/60 p-8 text-center shadow-lg">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 font-fredoka">
    ...
    return (
        <div className="space-y-5">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white font-fredoka drop-shadow-sm flex items-center gap-2">
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center gap-5 sm:gap-6">
                                ...
                                <div className="flex-1 w-full lg:w-auto mt-2 lg:mt-0">
                                    <div className="flex justify-between text-sm mb-2">
                                        ...
                                        <span className="font-bold text-gray-900 dark:text-white drop-shadow-sm">
                                    ...
                                    <div className="flex items-center gap-4 flex-shrink-0 mt-3 lg:mt-0 justify-between lg:justify-end">
                                        {status.remaining_amount > 0 && (
                                            <div className="text-right">
                                                ...
                                                <p className="text-sm font-black text-red-500 drop-shadow-sm">
                                                    {status.remaining_amount.toLocaleString()}
                                                </p>
                                            </div>
                                        )}
                                        <span className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold shadow-sm backdrop-blur-md border ${
                                            status.status === 'paid'
