...
export default function AboutPage() {
 ...
 whileInView={{ opacity: 1, y: 0 }}
 viewport={{ once: true }}
 className="text-4xl md:text-5xl font-semibold text-slate-800 dark:text-slate-100 mb-8 tracking-tighter uppercase font-fredoka"
 >
 ...
 <h3 className="text-xl font-medium text-slate-800 dark:text-slate-100 mb-4">{feature.title}</h3>
 ...
 <div>
 <h2 className="text-4xl font-semibold text-slate-800 dark:text-slate-100 mb-12 relative z-10 tracking-tighter uppercase font-fredoka">{t('footer.contact')}</h2>
 ...
 <div>
 <h3 className="text-xl font-medium text-slate-800 dark:text-slate-100">{t('about.call_center')}</h3>
 <p className="text-gray-500 dark:text-gray-400">{t('about.days')}, 9:00 - 18:00</p>
 </div>
 </div>
 <a
 href="tel:+998955137776"
 className="block text-center bg-white dark:bg-slate-800 text-brand-blue dark:text-blue-400 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold py-4 sm:py-5 rounded-[1.5rem] shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-md transition-all duration-300 active:scale-[0.98]"
 >
 +998 95 513 77 76
 </a>
 </div>
 ...
 <div>
 <h3 className="font-medium text-slate-800 dark:text-slate-100 text-lg mb-2">{t('about.location')}</h3>
 ...
 <div>
 <h3 className="font-medium text-slate-800 dark:text-slate-100 text-lg mb-2">{t('about.working_hours')}</h3>
 <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
