...
const VideoCard = ({ video, index }: { video: { id: string, title: string }, index: number }) => {
 ...
 <span className="px-3 py-1 rounded-full bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 text-[11px] font-semibold tracking-wider uppercase">
 YouTube
 </span>
 ...
 <h3 className="font-medium text-slate-800 dark:text-slate-100 text-lg md:text-xl line-clamp-3 leading-snug">
 {video.title}
 </h3>
 </div>
 </motion.div>
...
export default function ResultsPage() {
 ...
 viewport={{ once: true }}
 className="text-3xl md:text-4xl font-semibold text-slate-800 dark:text-slate-100 tracking-tight flex items-center gap-4"
 >
