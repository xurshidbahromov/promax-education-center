                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            {courseDetails[id] ? (
                                <div className="space-y-8">
                                    {courseDetails[id].programs.map((program, index) => (
                                        ...
                                        >
                                            <h2 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-slate-100 mb-8 flex items-start gap-4 tracking-tighter uppercase font-fredoka">
                                ...
                                >
                                    <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-8 flex items-center gap-4 tracking-tighter uppercase font-fredoka">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            >
                                <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-6 flex items-center gap-4 tracking-tighter uppercase font-fredoka">
                                    <span className={`p-3 rounded-xl ${course.bg} ${course.color} shadow-sm`}>
                                        <BookOpen size={28} />
                                    </span>
                                    {t('course.materials')}
