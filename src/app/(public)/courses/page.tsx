...
export default function CoursesPage() {
 ...
 <h3 className="pl-[68px] sm:pl-[76px] pt-[22px] sm:pt-[26px] text-lg sm:text-xl font-medium text-slate-800 dark:text-slate-100 transition-colors duration-300">
 {t(`courses.${course.id}`)}
 </h3>
 </div>
 ...
 <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md border border-black/5 dark:border-white/10 px-3 py-1 rounded-full text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider">
 Offline
 </div>
 ...
 <div className="flex items-center justify-between mt-auto">
 <div className="bg-purple-50/80 dark:bg-purple-500/10 backdrop-blur-md border border-purple-100 dark:border-purple-500/20 px-3 py-1 rounded-full text-xs font-medium text-purple-600 dark:text-purple-300 uppercase tracking-wider">
 Certificate
 </div>
 ...
 <h3 className="pl-[84px] sm:pl-[96px] pt-[26px] sm:pt-[30px] text-xl sm:text-2xl font-medium text-slate-800 dark:text-slate-100 transition-colors duration-300">
 {t(`courses.${course.id}`)}
 </h3>
 </div>
 ...
 <div className="flex items-center justify-between mt-auto">
 <div className="bg-orange-50/80 dark:bg-orange-500/10 backdrop-blur-md border border-orange-100 dark:border-orange-500/20 px-4 py-1.5 rounded-full text-xs font-medium text-brand-orange dark:text-orange-300 uppercase tracking-wider">
 Intensive
 </div>
