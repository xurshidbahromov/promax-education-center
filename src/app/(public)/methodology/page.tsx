...
const MethodologyPage = () => {
 ...
 <div className="absolute -top-12 -left-6 text-[12rem] font-semibold text-slate-800/[0.03] dark:text-slate-100/[0.02] -z-10 select-none leading-none">
 ...
 <span className={`text-xl font-medium uppercase tracking-widest ${step.color}`}>
 Qadam {t(`methodology.${step.id}.num`)}
 </span>
 </div>

 <h2 className="text-4xl md:text-5xl font-semibold text-slate-800 dark:text-slate-100 leading-tight tracking-tighter uppercase font-fredoka">
