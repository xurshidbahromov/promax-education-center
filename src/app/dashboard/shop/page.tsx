    ...
    <div className="relative text-slate-800 dark:text-white font-sans pb-8 select-none">
      ...
      <div className="relative z-10 flex flex-col gap-6 max-w-[1400px] mx-auto pt-1 sm:pt-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {/* Coins Balance Card */}
          <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-800/60 rounded-[2rem] p-4 flex items-center gap-3 shadow-none shrink-0">
            <div className="w-10 h-10 rounded-2xl bg-amber-500 text-white flex items-center justify-center font-bold shadow-none shrink-0">
              <Coins size={20} />
            </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3 border-b border-slate-200/50 dark:border-slate-800/50 pb-2 overflow-x-auto no-scrollbar">
          <button
            ...
            className={`px-4 sm:px-5 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer shadow-none ${
              activeTab === 'shop'
              ...
              {categories.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer shadow-none ${
                      isActive
