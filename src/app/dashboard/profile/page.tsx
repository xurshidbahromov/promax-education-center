...
export default function ProfilePage() {
    ...
    const [formData, setFormData] = useState({
        ...
        email: "azizbek.t@example.com",
        phone: "+998 90 123 45 67",
        bio: "IELTS 7.0 maqsadi sari olg'a! 🚀",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(false);
        // Show success message (toast implementation future)
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1 space-y-6">
                    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-gray-200 dark:border-slate-800 shadow-sm text-center relative overflow-hidden group">
                        ...
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Azizbek T.</h2>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Student ID: #2024001</p>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-100 dark:border-slate-800 grid grid-cols-2 gap-4 text-center">
                            ...
                            <div>
                                <div className="text-2xl font-bold text-brand-orange">1,250</div>
                    ...
                    <div className="bg-gradient-to-br from-brand-blue to-indigo-600 rounded-3xl p-6 text-white shadow-lg">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="font-bold">Pro Status</h3>
                        </div>
                        <p className="text-blue-100 text-sm mb-4">You are a consistent learner! Keep it up to unlock more benefits.</p>
                        <div className="h-2 bg-black/20 rounded-full overflow-hidden">
                            <div className="h-full bg-white/40 w-[85%]" />
                        </div>
                        <p className="text-xs text-blue-200 mt-2 text-right">Top 15%</p>
                    </div>
                </div>
