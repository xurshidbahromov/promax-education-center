...
export default function ProfilePage() {
 ...
 <button onClick={() => setActiveView('main')} className="p-2.5 rounded-full bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-700/50 active:bg-white dark:active:bg-slate-800 transition-all shadow-sm">
 ...
 <button onClick={onClick} className="w-full bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[1.5rem] p-4 flex items-center gap-4 shadow-sm border border-white/60 dark:border-slate-700/50 active:scale-95 active:border-brand-blue/30 dark:active:border-brand-blue/30 transition-all duration-300 group">
 <div className="w-10 h-10 text-brand-blue flex items-center justify-center group-active:scale-95 transition-all duration-300">
 ...
 <ChevronRight size={20} className="text-slate-300 dark:text-slate-600 group-active:scale-95 group-active:text-brand-blue transition-all" />
 </button>
 );
 ...
 <div className="relative w-[110px] h-[110px] rounded-[2rem] shadow-lg border-[3px] border-white/80 dark:border-slate-700/50 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl flex items-center justify-center overflow-hidden mb-4 group transition-transform active:scale-95">
 {avatarUrl ? (
 <Image src={avatarUrl} alt="Avatar" fill className="object-cover" />
 ) : (
 <User size={48} className="text-brand-blue/50 dark:text-slate-500" />
 )}
 <button onClick={() => fileInputRef.current?.click()} className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center opacity-0 group-active:opacity-100 transition-opacity">
 ...
 className="w-full bg-red-500/5 dark:bg-red-500/5 backdrop-blur-xl rounded-[1.5rem] p-4 flex items-center gap-4 shadow-sm border border-red-500/10 dark:border-red-500/20 active:border-red-500/30 dark:active:border-red-500/40 active:scale-95 transition-all duration-300 group mt-4"
 >
 <div className="w-10 h-10 text-red-500 flex items-center justify-center group-active:scale-95 transition-all duration-300">
 ...
 <ChevronRight size={20} className="text-red-300 dark:text-red-700 group-active:scale-95 group-active:text-red-500 transition-transform" />
 </button>
 </div>
 </div>
 );
 ...
 className="w-full py-3.5 bg-gradient-to-r from-brand-blue to-blue-600 active:scale-95 text-white rounded-xl font-bold text-[15px] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
 >
 ...
 className={cn(
 "flex flex-col items-center justify-center gap-3 p-5 rounded-[1.25rem] border-2 transition-all bg-white/50 dark:bg-slate-800/50 active:scale-95",
 theme === 'light' ? "border-brand-blue bg-blue-50/50 dark:bg-slate-800 shadow-md" : "border-gray-200/50 dark:border-slate-700/50 active:border-brand-blue/30 shadow-sm"
 )}
 >
 ...
 className={cn(
 "flex flex-col items-center justify-center gap-3 p-5 rounded-[1.25rem] border-2 transition-all bg-white/50 dark:bg-slate-800/50 active:scale-95",
 theme === 'dark' ? "border-brand-blue bg-blue-50/50 dark:bg-slate-800 shadow-md" : "border-gray-200/50 dark:border-slate-700/50 active:border-brand-blue/30 shadow-sm"
 )}
 >
 <div className="transition-all duration-300">
 ...
 : "border-gray-200/50 dark:border-slate-700/50 text-slate-500 active:border-brand-blue/30"
 )}
 >
 {l}
 </button>
 ...
 {faqs.map((faq, idx) => (
 <details key={idx} className="group bg-white/50 dark:bg-slate-800/50 rounded-xl p-4 border border-gray-100/50 dark:border-slate-700/50 transition-all cursor-pointer">
 ...
 className="flex items-center gap-4 p-4 rounded-[1.25rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-700/50 active:border-brand-blue/30 dark:active:border-brand-blue/30 transition-all group active:scale-95"
 >
 <div className="w-10 h-10 text-brand-blue flex items-center justify-center group-active:scale-95 transition-all duration-300">
 <MessageSquare size={26} strokeWidth={2.5} />
 </div>
 <div className="text-left">
 <h4 className="font-bold text-[15px] text-slate-800 dark:text-slate-100 group-active:text-brand-blue transition-colors">
 ...
 <ChevronRight size={18} className="ml-auto text-slate-400 group-active:scale-95 group-active:text-brand-blue transition-all" />
 </a>
 ...
 target="_blank" 
 rel="noopener noreferrer"
 className="flex items-center gap-4 p-4 rounded-[1.25rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-700/50 active:border-purple-500/30 dark:active:border-purple-500/30 transition-all group active:scale-95"
 >
 <div className="w-10 h-10 text-purple-600 flex items-center justify-center group-active:scale-95 transition-all duration-300">
 <MessageSquare size={26} strokeWidth={2.5} />
 </div>
 <div className="text-left">
 <h4 className="font-bold text-[15px] text-slate-800 dark:text-slate-100 group-active:text-purple-600 transition-colors">
 ...
 <ChevronRight size={18} className="ml-auto text-slate-400 group-active:scale-95 group-active:text-purple-600 transition-all" />
 </a>

 <a 
 href="tel:+998901234567" 
 className="flex items-center gap-4 p-4 rounded-[1.25rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-700/50 active:border-green-500/30 dark:active:border-green-500/30 transition-all group active:scale-95"
 >
 <div className="w-10 h-10 text-green-600 flex items-center justify-center group-active:scale-95 transition-all duration-300">
 <Phone size={26} strokeWidth={2.5} />
 </div>
 <div className="text-left">
 <h4 className="font-bold text-[15px] text-slate-800 dark:text-slate-100 group-active:text-green-600 transition-colors">
 {t('profile.view.contact.call_center') || "Call Center"}
 </h4>
 <p className="text-[13px] font-medium text-slate-500 mt-0.5">+998 (90) 123-45-67</p>
 </div>
 <ChevronRight size={18} className="ml-auto text-slate-400 group-active:scale-95 group-active:text-green-600 transition-all" />
 </a>

 <a 
 href="mailto:support@promax.uz" 
 className="flex items-center gap-4 p-4 rounded-[1.25rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-700/50 active:border-orange-500/30 dark:active:border-orange-500/30 transition-all group active:scale-95"
 >
 <div className="w-10 h-10 text-orange-600 flex items-center justify-center group-active:scale-95 transition-all duration-300">
 <Mail size={26} strokeWidth={2.5} />
 </div>
 <div className="text-left">
 <h4 className="font-bold text-[15px] text-slate-800 dark:text-slate-100 group-active:text-orange-600 transition-colors">
 {t('profile.view.contact.email') || "Email yordam"}
 </h4>
 <p className="text-[13px] font-medium text-slate-500 mt-0.5">support@promax.uz</p>
 </div>
 <ChevronRight size={18} className="ml-auto text-slate-400 group-active:scale-95 group-active:text-orange-600 transition-all" />
 </a>
 </div>
 </div>
 </div>
