 ...
 await updateUserSettings(newSettings);
  ...
  const ViewHeader = ({ title }: { title: string }) => (
    <div className="flex items-center gap-4 mb-6">
      <button onClick={() => setActiveView('main')} className="p-2.5 rounded-full bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-800/60 active:bg-white dark:active:bg-slate-800 transition-all shadow-none">
  ...
  const MenuButton = ({ icon: Icon, title, description, onClick }: any) => (
    <button onClick={onClick} className="w-full bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] p-4.5 flex items-center gap-4 shadow-none border border-white/60 dark:border-slate-800/60 active:scale-[0.99] active:border-brand-blue/30 dark:active:border-brand-blue/30 transition-all duration-300 group">
      <div className="w-11 h-11 rounded-2xl bg-brand-blue/10 dark:bg-brand-blue/20 text-brand-blue flex items-center justify-center group-hover:scale-105 transition-all duration-300 shrink-0">
        <Icon size={24} className="stroke-[2.2px]" />
      </div>
      <div className="flex-1 text-left">
        <h3 className="font-bold text-slate-800 dark:text-slate-100 text-[15px] font-fredoka">{title}</h3>
        <p className="text-[13px] text-slate-500 dark:text-slate-400 mt-0.5 font-medium">{description}</p>
      </div>
      <ChevronRight size={20} className="text-slate-300 dark:text-slate-600 group-hover:translate-x-1 group-hover:text-brand-blue transition-all shrink-0" />
    </button>
  );
  ...
  const renderMain = () => (
    <div className="flex flex-col items-center">
      ...
      <div className="relative w-full flex flex-col items-center pt-2 pb-8">
        <div className="relative w-[110px] h-[110px] rounded-[2rem] shadow-none border-[3px] border-white/80 dark:border-slate-800/80 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl flex items-center justify-center overflow-hidden mb-4 group transition-transform active:scale-95">
          {avatarUrl ? (
            <Image src={avatarUrl} alt="Avatar" fill className="object-cover" />
          ) : (
            <User size={48} className="text-brand-blue/50 dark:text-slate-500" />
          )}
          <button onClick={() => fileInputRef.current?.click()} className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
      ...
      <div className="w-full space-y-3">
        ...
        <button 
          ...
          className="w-full bg-red-500/5 dark:bg-red-500/5 backdrop-blur-xl rounded-[2rem] p-4.5 flex items-center gap-4 shadow-none border border-red-500/10 dark:border-red-500/20 active:border-red-500/30 dark:active:border-red-500/40 active:scale-[0.99] transition-all duration-300 group mt-4 cursor-pointer"
        >
          <div className="w-11 h-11 rounded-2xl bg-red-500/10 dark:bg-red-500/20 text-red-500 flex items-center justify-center group-hover:scale-105 transition-all duration-300 shrink-0">
            <LogOut size={22} className="stroke-[2.5px]" />
          </div>
          <div className="flex-1 text-left">
            <h3 className="font-bold text-red-600 dark:text-red-400 text-[15px] font-fredoka">
          ...
          <ChevronRight size={20} className="text-red-300 dark:text-red-700 group-hover:translate-x-1 group-hover:text-red-500 transition-all shrink-0" />
        </button>
      </div>
    </div>
  );
  ...
  const renderProfileEdit = () => (
    <div className="w-full pt-2">
      ...
      <form onSubmit={handleProfileSubmit} className="space-y-6">
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] p-6 shadow-none border border-white/60 dark:border-slate-800/60 space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/50 dark:bg-slate-800/50 border border-slate-200/60 dark:border-slate-700/50 rounded-2xl focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-all dark:text-slate-100 font-medium"
              />
            </div>
            <div className="space-y-2">
        ...
        <button
          ...
          className="w-full py-3.5 bg-brand-blue active:scale-95 text-white rounded-2xl font-bold text-[15px] transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-none cursor-pointer"
        >
  ...
  const renderThemes = () => (
    <div className="w-full pt-2">
      ...
      <div className="space-y-6">
        {/* Theme Selection */}
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] p-6 shadow-none border border-white/60 dark:border-slate-800/60 space-y-6">
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className={cn(
                  "flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all bg-white/50 dark:bg-slate-800/50 active:scale-95 cursor-pointer shadow-none",
                  theme === 'light' ? "border-brand-blue bg-blue-50/50 dark:bg-slate-800" : "border-slate-200/60 dark:border-slate-700/50 active:border-brand-blue/30"
                )}
              >
              ...
              <button
                ...
                className={cn(
                  "flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 transition-all bg-white/50 dark:bg-slate-800/50 active:scale-95 cursor-pointer shadow-none",
                  theme === 'dark' ? "border-brand-blue bg-blue-50/50 dark:bg-slate-800" : "border-slate-200/60 dark:border-slate-700/50 active:border-brand-blue/30"
                )}
              >
                <div className="transition-all duration-300">
            ...
            <div className="grid grid-cols-3 gap-3">
              {(['UZ', 'RU', 'EN'] as const).map((l) => (
                <button
                  ...
                  className={cn(
                    "py-3 rounded-2xl border-2 font-bold text-[14px] transition-all bg-white/50 dark:bg-slate-800/50 cursor-pointer shadow-none",
                    language === l 
                      ? "border-brand-blue bg-brand-blue/5 text-brand-blue" 
                      : "border-slate-200/60 dark:border-slate-700/50 text-slate-500 active:border-brand-blue/30"
                  )}
                >
                  {l}
                </button>
    ...
    <div className="w-full pt-2">
      ...
      <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] p-6 shadow-none border border-white/60 dark:border-slate-800/60 space-y-6">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center justify-between bg-white/50 dark:bg-slate-800/50 p-4 rounded-2xl border border-slate-100/50 dark:border-slate-700/50">
            ...
            <button 
              ...
              className={cn("w-14 h-7 rounded-full transition-colors relative shadow-none cursor-pointer", notifications.email ? "bg-brand-blue" : "bg-slate-200 dark:bg-slate-700")}
            >
              <div className={cn("absolute top-1 left-1 bg-white w-5 h-5 rounded-full transition-transform shadow-none", notifications.email ? "translate-x-7" : "translate-x-0")} />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between bg-white/50 dark:bg-slate-800/50 p-4 rounded-2xl border border-slate-100/50 dark:border-slate-700/50">
            ...
            <button 
              ...
              className={cn("w-14 h-7 rounded-full transition-colors relative shadow-none cursor-pointer", notifications.push ? "bg-brand-blue" : "bg-slate-200 dark:bg-slate-700")}
            >
              <div className={cn("absolute top-1 left-1 bg-white w-5 h-5 rounded-full transition-transform shadow-none", notifications.push ? "translate-x-7" : "translate-x-0")} />
            </button>
          </div>
        </div>
      </div>
  ...
  const renderHelp = () => {
    ...
    return (
      <div className="w-full pt-2">
        ...
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] p-6 shadow-none border border-white/60 dark:border-slate-800/60 space-y-4">
          {faqs.map((faq, idx) => (
            <details key={idx} className="group bg-white/50 dark:bg-slate-800/50 rounded-2xl p-4 border border-slate-100/50 dark:border-slate-700/50 transition-all cursor-pointer">
  ...
  const renderContact = () => {
    ...
    return (
      <div className="w-full pt-2">
        <ViewHeader title={title} />
        <div className="mt-6">
          <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] p-8 shadow-none border border-white/60 dark:border-slate-800/60 text-center space-y-3 mb-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            <a 
              ...
              className="flex items-center gap-4 p-4.5 rounded-[2rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-800/60 hover:border-brand-blue/40 dark:hover:border-brand-blue/40 transition-all group active:scale-[0.99] shadow-none"
            >
              <div className="w-11 h-11 rounded-2xl bg-brand-blue/10 dark:bg-brand-blue/20 text-brand-blue flex items-center justify-center group-hover:scale-105 transition-all duration-300 shrink-0">
                <MessageSquare size={24} strokeWidth={2.2} />
              </div>
              <div className="text-left">
                <h4 className="font-bold text-[15px] font-fredoka text-slate-800 dark:text-slate-100 group-hover:text-brand-blue transition-colors">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center gap-4 p-4.5 rounded-[2rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-800/60 hover:border-purple-500/40 dark:hover:border-purple-500/40 transition-all group active:scale-[0.99] shadow-none"
            >
              <div className="w-11 h-11 rounded-2xl bg-purple-500/10 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 flex items-center justify-center group-hover:scale-105 transition-all duration-300 shrink-0">
                <MessageSquare size={24} strokeWidth={2.2} />
              </div>
              <div className="text-left">
                <h4 className="font-bold text-[15px] font-fredoka text-slate-800 dark:text-slate-100 group-hover:text-purple-600 transition-colors">
            ...
            <a 
              ...
              className="flex items-center gap-4 p-4.5 rounded-[2rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-800/60 hover:border-green-500/40 dark:hover:border-green-500/40 transition-all group active:scale-[0.99] shadow-none"
            >
              <div className="w-11 h-11 rounded-2xl bg-green-500/10 dark:bg-green-500/20 text-green-600 dark:text-green-400 flex items-center justify-center group-hover:scale-105 transition-all duration-300 shrink-0">
                <Phone size={24} strokeWidth={2.2} />
              </div>
              <div className="text-left">
                <h4 className="font-bold text-[15px] font-fredoka text-slate-800 dark:text-slate-100 group-hover:text-green-600 transition-colors">
            ...
            <a 
              ...
              className="flex items-center gap-4 p-4.5 rounded-[2rem] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-white/60 dark:border-slate-800/60 hover:border-orange-500/40 dark:hover:border-orange-500/40 transition-all group active:scale-[0.99] shadow-none"
            >
              <div className="w-11 h-11 rounded-2xl bg-orange-500/10 dark:bg-orange-500/20 text-orange-600 dark:text-orange-400 flex items-center justify-center group-hover:scale-105 transition-all duration-300 shrink-0">
                <Mail size={24} strokeWidth={2.2} />
              </div>
              <div className="text-left">
                <h4 className="font-bold text-[15px] font-fredoka text-slate-800 dark:text-slate-100 group-hover:text-orange-600 transition-colors">
