...
export default function ResultsPage() {
 ...
 return (
 <div key={result.id} className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[1.5rem] border border-white/60 dark:border-slate-700/50 overflow-hidden shadow-sm active:scale-95 transition-all duration-300">
 ...
 className="px-4 py-2 bg-white/60 dark:bg-slate-800/60 active:bg-white dark:active:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-[14px] text-[13px] font-bold transition-colors border border-gray-200/50 dark:border-slate-700/50 shadow-sm flex items-center gap-2"
 >
 <Eye size={16} />
 Ko'rish
 </Link>
 <Link
 href={`/dashboard/results/${result.id}`}
 className="px-4 py-2 bg-brand-blue/10 active:bg-brand-blue/20 text-brand-blue rounded-[14px] text-[13px] font-bold transition-colors flex items-center gap-2"
 >
 Tahlil
 </Link>
 </div>
