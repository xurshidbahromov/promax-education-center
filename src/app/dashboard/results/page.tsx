      ...
      <div className="relative z-10 flex flex-col gap-6 max-w-[1600px] mx-auto pt-1 sm:pt-2">
        ...
        <div className="flex flex-col gap-4 mt-2">
          {loading ? (
            ...
            <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] border border-white/60 dark:border-slate-800/60 p-12 flex flex-col items-center gap-4 text-center mt-4 shadow-none">
            ...
            filteredResults.map((result) => {
              ...
              return (
                <div key={result.id} className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2rem] border border-white/60 dark:border-slate-800/60 overflow-hidden shadow-none active:scale-[0.99] transition-all duration-300">
                  <div className="p-5 sm:p-6">
                    <div className="flex flex-col md:flex-row justify-between gap-6">
                      ...
                      <div className="space-y-3 flex-1">
                        ...
                        <h3 className="text-xl font-bold font-fredoka text-slate-900 dark:text-white leading-tight">
                        ...
                        {isDTM && (
                          <div className="flex flex-wrap gap-2 mt-2">
                            ...
                            <div className="px-3 py-1.5 bg-white/60 dark:bg-slate-800/60 rounded-xl text-[12px] font-medium border border-white/60 dark:border-slate-800/60 flex items-center gap-1.5 shadow-none">
                            ...
                            {result.subject_1_score !== undefined && result.subject_1_score !== null && (
                              <div className="px-3 py-1.5 bg-blue-50/60 dark:bg-blue-900/20 rounded-xl text-[12px] font-medium border border-blue-200/50 dark:border-blue-800/50 flex items-center gap-1.5 shadow-none">
                      ...
                      <div className="flex flex-col sm:items-end justify-between gap-4 shrink-0">
                        ...
                        <div className="flex items-center gap-2">
                          <Link
                            ...
                            className="px-4 py-2 bg-slate-100 dark:bg-slate-800 active:bg-slate-200 dark:active:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-2xl text-[13px] font-bold transition-colors border border-slate-200/60 dark:border-slate-700/60 shadow-none flex items-center gap-2"
                          >
                            <Eye size={16} />
                            Ko'rish
                          </Link>
                          <Link
                            href={`/dashboard/results/${result.id}`}
                            className="px-4 py-2 bg-brand-blue/10 active:bg-brand-blue/20 text-brand-blue rounded-2xl text-[13px] font-bold transition-colors flex items-center gap-2"
                          >
                            Tahlil
                          </Link>
                        </div>
