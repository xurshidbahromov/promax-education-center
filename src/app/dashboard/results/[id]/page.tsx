...
export default function ResultDetailPage() {
 ...
 className="text-brand-blue active:underline mt-4 inline-block"
 >
 ...
 <button
 onClick={() => router.push('/dashboard/results')}
 className="inline-flex items-center gap-2 text-slate-500 dark:text-slate-400 active:text-brand-blue dark:active:text-brand-blue transition-colors font-medium bg-white/60 dark:bg-slate-900/60 px-4 py-2.5 rounded-2xl backdrop-blur-xl border border-gray-200/50 dark:border-slate-800/50 shadow-sm"
 >
 <ArrowLeft size={18} />
 ...
 {/* Compulsory Block */}
 <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl p-6 rounded-[1.5rem] border border-white/60 dark:border-slate-700/50 shadow-sm transition-all group">
 <div className="flex items-center gap-3 mb-6">
 <div className="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 group-active:scale-95 group-active:text-brand-blue group-active:bg-brand-blue/10 transition-all duration-300">
 <BookOpen size={24} />
 </div>
 <div>
 ...
 <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl p-6 rounded-[1.5rem] border border-white/60 dark:border-slate-700/50 shadow-sm transition-all group">
 <div className="flex items-center gap-3 mb-6">
 <div className="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-brand-blue group-active:scale-95 group-active:bg-brand-blue group-active:text-white transition-all duration-300">
 <Trophy size={24} />
 </div>
 <div>
 ...
 <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl p-6 rounded-[1.5rem] border border-white/60 dark:border-slate-700/50 shadow-sm transition-all group">
 <div className="flex items-center gap-3 mb-6">
 <div className="w-12 h-12 rounded-2xl bg-purple-50 dark:bg-purple-900/20 flex items-center justify-center text-purple-500 group-active:scale-95 group-active:bg-purple-500 group-active:text-white transition-all duration-300">
 <Trophy size={24} />
 </div>
 <div>
