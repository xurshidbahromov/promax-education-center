...
export default function ResultDetailPage() {
 ...
 <div className="text-3xl font-medium text-brand-blue">
 ...
 <div className={`text-3xl font-medium ${(attempt.percentage || 0) >= 80 ? 'text-green-500' :
 ...
 <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-white dark:bg-slate-900 shadow-sm text-sm font-medium">
 {key}
 </div>
 ...
 <div>
 <span className="font-medium block mb-1">Tushuntirish:</span>
 {question.explanation}
 </div>
 </div>
 )}
