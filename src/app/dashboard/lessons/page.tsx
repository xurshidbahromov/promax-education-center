...
export default function LessonsPage() {
 ...
 className="flex flex-col w-full h-full rounded-[1.5rem] overflow-hidden border border-white/60 dark:border-slate-700/50 shadow-sm transition-all duration-300 group bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl"
 >
