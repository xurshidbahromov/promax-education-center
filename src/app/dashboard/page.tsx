...
const subjectMeta: Record<string, { color: string; bg: string; icon: any }> = {
 ...
 default: { color: "text-brand-blue", bg: "bg-brand-blue/10", icon: BookOpenText },
};
...
export default function DashboardPage() {
 ...
 className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[1.5rem] p-4 border border-white/60 dark:border-slate-700/50 shadow-sm active:bg-white/80 dark:active:bg-slate-800/80 transition-all duration-300 flex flex-col gap-3 group block"
 >
 ...
 <Link
 href={card.href}
 className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[1.5rem] p-4 border border-white/60 dark:border-slate-700/50 shadow-sm active:scale-95 transition-all duration-300 flex items-center gap-4 group block"
 >
 ...
 >
 {[
 { label: "Testlar", value: stats?.totalTests ?? 0, icon: FileCheck, color: "text-brand-blue", bg: "bg-brand-blue/10" },
 { label: "O'rtacha", value: `${stats?.averageScore ?? 0}%`, icon: TrendingUp, color: "text-emerald-600", bg: "bg-emerald-100 dark:bg-emerald-900/30", isStr: true },
 ...
 >
 <div className={`flex items-center justify-center mb-1 transition-transform active:scale-95`}>
 ...
 className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[1.5rem] p-4 border border-white/60 dark:border-slate-700/50 shadow-sm active:bg-white/80 dark:active:bg-slate-800/80 transition-all flex items-center gap-4 group"
 >
 <div className="flex items-center justify-center shrink-0 group-active:scale-95 transition-transform">
 <FileCheck size={28} className="text-violet-600" />
 </div>
 <div className="flex-1 min-w-0">
