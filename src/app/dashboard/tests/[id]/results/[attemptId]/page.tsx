...
export default function TestResultsPage() {
 ...
 <div className="text-3xl font-medium mb-1">{percentage.toFixed(0)}%</div>
 <div className="text-sm opacity-90">{t('tests.result.stat.score')}</div>
 </div>

 <div className="bg-white/10 backdrop-blur rounded-2xl p-4 text-center">
 <div className="text-3xl font-medium mb-1">{attempt.score}/{attempt.max_score}</div>
 <div className="text-sm opacity-90">{t('tests.result.stat.points')}</div>
 </div>

 <div className="bg-white/10 backdrop-blur rounded-2xl p-4 text-center">
 <div className="text-3xl font-medium mb-1">{correctCount}/{totalQuestions}</div>
 ...
 <span className="text-sm font-medium text-green-600 dark:text-green-400">{correctCount} / {totalQuestions}</span>
 </div>
 ...
 <span className="text-sm font-medium text-red-600 dark:text-red-400">{totalQuestions - correctCount} / {totalQuestions}</span>
 </div>
 <div className="w-full bg-gray-200 dark:bg-slate-800 rounded-full h-3">
 <div
 ...
 {showReview && (
 <div className="space-y-4">
 <h2 className="text-2xl font-medium text-slate-800 dark:text-slate-100 mb-6">
 ...
 {/* Question Text */}
 <p className="text-lg text-slate-800 dark:text-slate-100 mb-4">
