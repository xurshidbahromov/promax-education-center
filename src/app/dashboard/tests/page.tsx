...
export default function OnlineTestsPage() {
 ...
 className="bg-transparent border-none focus:ring-0 text-sm w-48 text-slate-800 dark:text-slate-100 placeholder-gray-400"
 />
 </div>
 </div>
 ...
 <span className={`px-3 py-1 rounded-full text-xs font-medium text-white bg-gradient-to-r ${colors.gradient}`}>
 {test.test_type.toUpperCase()}
 </span>
 </div>

 {/* Title */}
 <h3 className="text-lg font-medium text-slate-800 dark:text-slate-100 mb-3 group-hover:text-brand-blue transition-colors">
 {test.title}
 </h3>
 ...
 {/* Start Button */}
 <button className="w-full py-3 rounded-xl bg-gray-100 dark:bg-slate-800 text-slate-800 dark:text-slate-100 font-medium group-hover:bg-gradient-to-r group-hover:from-brand-blue group-hover:to-cyan-500 group-hover:text-white transition-all flex items-center justify-center gap-2">
 {t('tests.list.start')}
