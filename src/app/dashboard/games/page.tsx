...
export default function GameZonePage() {
 ...
 <div>
 <h1 className="text-3xl font-semibold text-slate-800 dark:text-slate-100 flex items-center gap-3 tracking-tighter uppercase font-fredoka">
 ...
 <div className="flex items-center gap-2 bg-brand-orange/10 px-4 py-2 rounded-2xl border border-brand-orange/20 text-brand-orange font-medium text-xl shadow-sm">
 ...
 <h3 className="text-xl font-medium text-slate-800 dark:text-slate-100 mb-2">{game.title}</h3>
 <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">{game.description}</p>

 <div className="mt-auto">
 {game.available ? (
 <button className={`px-6 py-2 rounded-full font-medium text-white bg-gradient-to-r ${game.color} shadow-md hover:shadow-lg transition-all flex items-center gap-2`}>
 ...
 <div className="text-5xl font-semibold text-slate-800 dark:text-slate-100 mb-8 font-mono tracking-wider">
 {question.q.replace('*', '×')}
 </div>
 ...
 autoFocus
 className="w-full text-center text-3xl font-medium py-3 bg-gray-50 dark:bg-slate-800 border-2 border-brand-blue rounded-xl focus:outline-none focus:ring-4 focus:ring-brand-blue/20 transition-all text-slate-800 dark:text-slate-100"
 placeholder="?"
 />
 <button
 type="submit"
 ...
 className="text-green-500 font-medium flex items-center justify-center gap-2"
 >
 ...
 initial={{ opacity: 0, y: 10 }}
 animate={{ opacity: 1, y: 0 }}
 className="text-red-500 font-medium flex items-center justify-center gap-2"
 >
 ...
 <h2 className="text-2xl font-medium text-slate-800 dark:text-slate-100 mb-2">Game Over!</h2>
 <p className="text-gray-500 dark:text-gray-400 mb-6">You earned</p>
 <div className="text-5xl font-semibold text-brand-orange mb-8 flex items-center justify-center gap-2">
 +{score} <span className="text-2xl">Coins</span>
 </div>
 <button
 onClick={closeGame}
 className="w-full py-3 bg-brand-blue text-white rounded-xl font-medium hover:bg-blue-600 transition-colors"
 >
 Awesome!
 </button>
 </div>
