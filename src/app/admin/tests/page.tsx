...
export default function AdminTestsPage() {
 ...
 <tr>
 <th className="px-6 py-4 text-left text-sm font-semibold text-slate-800 dark:text-slate-100">Test Nomi</th>
 <th className="px-6 py-4 text-left text-sm font-semibold text-slate-800 dark:text-slate-100">Fan</th>
 <th className="px-6 py-4 text-left text-sm font-semibold text-slate-800 dark:text-slate-100">Turi</th>
 <th className="px-6 py-4 text-left text-sm font-semibold text-slate-800 dark:text-slate-100">Savollar</th>
 <th className="px-6 py-4 text-left text-sm font-semibold text-slate-800 dark:text-slate-100">Vaqt</th>
 <th className="px-6 py-4 text-left text-sm font-semibold text-slate-800 dark:text-slate-100">Holat</th>
 <th className="px-6 py-4 text-right text-sm font-semibold text-slate-800 dark:text-slate-100">Amallar</th>
 </tr>
 </thead>
 ...
 <div className="text-3xl font-medium text-slate-800 dark:text-slate-100">{tests.length}</div>
 </div>
