...
export default function ResultsPage() {
 ...
 <div className="text-6xl font-medium mb-2 tracking-tight">
 ...
 <h4 className="font-medium text-slate-800 dark:text-slate-100 mb-4 flex items-center gap-2">
 ...
 <li className="pt-3 border-t border-gray-100 dark:border-slate-800 flex justify-between font-medium text-gray-700 dark:text-gray-200">
 <span>MAX TOTAL</span>
 <span>189.0</span>
 </li>
 </ul>
