...
import { toInputDateFormat, toInputTimeFormat } from "@/lib/tournament-timing";
import {
...
export default function CreateInternationalTournamentPage() {
  ...
  const handleSaveTournament = async (publish: boolean = false) => {
    ...
    try {
      ...
      toast.success(
        publish
          ? "Musobaqa yaratildi va Jonli (Faol) qilindi!"
          : "Musobaqa qoralama sifatida saqlandi!"
      );
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto space-y-6 pb-20">
      ...
      <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-medium mt-0.5">
                    Xalqaro musobaqa nomi, formati va parametrlarini kiriting
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Masalan: Digital SAT Grand League 2026 (Math & Reading 1600)"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Test vaqti 70 daqiqa.&#10;Multiple choice va Grid-in savollar mavjud.&#10;Vaqt tugaganda avtomatik yakunlanadi."
                    className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-blue/30 outline-none text-xs font-medium text-slate-800 dark:text-slate-100 resize-none h-20 font-mono"
                  />
                </div>
              </div>
        ...
        {/* STEP 3: Preview & Save (1:1 with /admin/tournaments/create) */}
        {currentStep === "preview" && (
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 sm:p-8 space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
              <div className="flex items-center gap-2.5">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-800/50">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  disabled={saving}
                  className="px-4 py-2.5 text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 rounded-xl disabled:opacity-50 cursor-pointer"
                >
                ...
                <button
                  ...
                  disabled={saving}
                  className="px-5 py-2.5 text-xs sm:text-sm font-bold text-white bg-emerald-500 hover:bg-emerald-600 rounded-xl disabled:opacity-50 shadow-md shadow-emerald-500/10 cursor-pointer"
                >
