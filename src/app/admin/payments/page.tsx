 ...
 *,
 ...
 toast("Export qilish uchun to'lovlar yo'q", { icon: "⚠️" });
 return;
 }
 ...
 toast.success(`${recentPayments.length} ta to'lov Excel formatida yuklandi`);
 } catch (error) {
 ...
 <td className="py-4 px-4 text-sm font-medium text-slate-800 dark:text-slate-100">
 {payment.student_name}
 </td>
