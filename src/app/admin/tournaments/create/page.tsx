...
export default function CreateTournamentPage() {
  ...
  // ── STEP 2: QUESTIONS BUILDER (Fresh empty array) ──
  ...
  const handleSaveTournament = async (publish: boolean = false) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        toast.error("Musobaqa yaratishda xatolik yuz berdi");
      }
    } catch (error) {
  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto space-y-6 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-2 border-b border-slate-200/50 dark:border-slate-800/50">
        ...
        {/* Sequential Step Navigation Bar (1:1 with CreateTestPage) */}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {currentStep === "basic" && (
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 sm:p-8 space-y-6">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-medium mt-0.5">
                    Musobaqa nomi va parametrlarini kiriting
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              {/* Tournament Specific Fields: Date, Time, Prize Pool, Entry Coins */}
            ...
            {/* Sequential Step Footer Action (1:1 with CreateTestPage) */}
        ...
        {currentStep === "questions" && (
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 sm:p-8 space-y-6">
            ...
            {/* Question Editor Modal (1:1 with CreateTestPage) */}
            {editingQuestion && (
        ...
        {/* STEP 3: Preview & Save (1:1 with CreateTestPage) */}
        {currentStep === "preview" && (
          <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 sm:p-8 space-y-6">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
              <div className="flex items-center gap-2.5">
